...
public class royalvgz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_royalvgz);
    ...
    private void spin(){
        ...
        rotateAnimation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                Toast.makeText(royalvgz.this, "Selamat Untuk Penukaran Pada Bulan Ini Senilai " + sectors[sectors.length - (degree + 1)] + " point.", Toast.LENGTH_SHORT).show();
                isSpinning = false;
            }
    ...
    public void backroyalvgz(View v) {
        Intent intent = new Intent(royalvgz.this, ekstravgz.class);
        startActivity(intent);
    }

    public void royalhome(View v) {
        Intent intent = new Intent(royalvgz.this, home.class);
        startActivity(intent);
    }
